...
ColumnLayout {
    ...
    GridLayout {
        ...
        Rectangle {
            Layout.fillWidth: true
            Layout.minimumWidth: 0
            implicitHeight: bodyOptionLayout.implicitHeight + Fluent.Enums.spacing.xs * 2
        ...
        Rectangle {
            Layout.fillWidth: true
            Layout.minimumWidth: 0
            implicitHeight: boundaryLayout.implicitHeight + Fluent.Enums.spacing.xs * 2
            radius: Fluent.Enums.radius.small
            color: Fluent.Enums.stateColor.actionsRowBg
            border.color: Fluent.Enums.stateColor.settingCardBorder
            border.width: Fluent.Enums.border.thin
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    height: 8
                    radius: 4
                    color: Fluent.Enums.statusLevel.getColor(Fluent.Enums.statusLevel.infoStr)
